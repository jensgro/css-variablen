...
var canIUse = (function () {
    ...
    */
    ...
    var TMPL_TITLE = '<h3>{title}</h3>', // feature title {title}
        ...
        TMPL_DESCRIPTION = '<p>Unterstützt ab den folgenden Versionen:</p>', // description to user
        TMPL_DESKTOP_TITLE = '<h4>Desktop</h4>', // desktop header
        TMPL_MOBILE_TITLE = '<h4>Mobile / Tablet</h4>', // mobile header
        ...
        TMPL_PREFIX_NOTE = '<p class="caniuse-note">* vendor-prefix ist erforderlich.</p>',
        TMPL_LEGEND = '<ul class="legend"><li>Unterstützt:</li><li class="y">JA</li><li class="n">NEIN</li><li class="a">Teilweise</li><li class="p">Polyfill</li></ul>',
        TMPL_FOOTER = '<p class="stats">Statistiken von <a href="http://caniuse.com/#feat={feature}" target="_blank">caniuse.com</a></p>',
        TMPL_LOADING = '<h3>Lade</h3>',
        TMPL_ERROR = '<h3>Fehler</h3><p>Feature "{feature}" nicht gefunden!</p>';
